...
## Sprint 10 — Social Proof & Credibility

**Objective:** Add social proof elements. These build trust with recruiters and collaborators.

**Duration:** 3-4 days.

### Epic 10.1: Testimonials

| Task | Complexity | Dependencies |
|---|---|---|
| Create `testimonials.json` schema and data file | 1 | None |
| Create testimonial card component | 1 | Card component |
| Create testimonials section (homepage) editable | 2 | Section exists |
| Add testimonial request workflow (template message) | 1 | Contact section |

**Acceptance Criteria:**
- Testimonials rendered as quote cards with avatar, name, role, company
- Only shown if data exists
- Responsive grid (1-2 columns)
- Quotes are attributed and linkable

**Deliverables:** Testimonials section.

---

### Epic 10.2: Publications & Research

| Task | Complexity | Dependencies |
|---|---|---|
| Create `publications.json` schema and data file | 1 | None |
| Create publications section | 1 | Section component |
| Add citation formatting (APA/MLA toggle) | 2 | Publications section |
| Add DOI/arXiv link integration | 1 | Publications section |

**Acceptance Criteria:**
- Publications render as citation list
- Citation format toggle (APA / MLA / BibTeX)
- DOI links resolve correctly
- Only shown if data exists

**Deliverables:** Publications section.

---

### Epic 10.3: Speaking & Media

| Task | Complexity | Dependencies |
|---|---|---|
| Create `speaking.json` schema (talks, workshops, podcasts) | 1 | None |
| Create speaking section with event cards | 1 | Section component |
| Add video embed support (YouTube, Loom) | 2 | Speaking section |
| Add slides embed support (SpeakerDeck) | 2 | Speaking section |

**Acceptance Criteria:**
- Talks listed with event name, date, title
- Embedded video/slides where available
- Links to event page where applicable

**Deliverables:** Speaking section.
