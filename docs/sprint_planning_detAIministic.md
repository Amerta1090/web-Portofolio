...
- [x] `data/capability-grammars.json`: grammar utk one-liner capability, blurb proyek, random fact (ambil vocab dari skills/proyek/persona). Tak mengarang fakta.
- [x] Validate-data schema baru.
