...
- **Sprint tersisa**: L2.3 visual & narrative pass (token, hierarchy, responsive, theme, section-flow validation) → Sprint 3 Case Study Reactor → Sprint 4 QA/integration → Phase Final. MotionScore belum dijalankan (env server); baseline home B 56–58 tak tersentuh (L2.1+L2.2: 0 listener baru).
