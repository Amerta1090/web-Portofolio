...
- **Hasil sprint**: skor `/` 49→**56–58**, listeners 41→26, off-screen 6→3, thrashing S, GPU 662→606MB (floor). **Gap B→A = 2 HIGH struktural terdokumentasi** — bukan kode halaman (bukti: A/B GPU + pembacaan formula motionscore). Keputusan gap untuk user: rilis sebagai hasil sprint (rekomendasi, preseden §8 #10) vs lanjut rewrite hero/CodeDNAHelix ke CSS scroll-driven (kontraproduktif utk rasio listener — menurunkan jsScrollAnims menaikkan rasio).
