...
- **Sprint tersisa**: L2.2 bounded SVG choreography (signal travel, entry, cleanup, viewport guard, reduced-motion, low-power density) → L2.3 visual pass → Sprint 3 Case Study Reactor → Sprint 4 QA/integration → Phase Final. MotionScore belum dijalankan (env server); baseline home B 56–58 tak tersentuh (L2.1: 0 listener/RAF baru).
