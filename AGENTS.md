...
- **Sprint tersisa**: L3.3 Case Study Reactor (responsive composition: sticky desktop, stepper mobile, cek 375/768/wide) → Sprint 4 QA/integration → Phase Final. MotionScore belum dijalankan (env server); baseline home B 56–58 tak tersentuh (L2.1–L2.3 + 2 revisi + L3.1 + L3.2: 0 scroll listener/RAF/React root baru).
