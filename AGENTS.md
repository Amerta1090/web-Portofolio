...
- **Sprint tersisa**: L3.1–L3.3 Case Study Reactor (schema `processStages` → stage controls → responsive) → Sprint 4 QA/integration → Phase Final. MotionScore belum dijalankan (env server); baseline home B 56–58 tak tersentuh (L2.1–L2.3 + 2 revisi: 0 scroll listener/RAF baru; 1× ResizeObserver container pada L2.3 revision II — bukan scroll listener).
